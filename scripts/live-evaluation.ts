...
try {
  ...
  const report = {
    version: "0.0.1-rc.2", generatedAt: new Date().toISOString(), provider: "deepseek", modelId,
  ...
  writeFileSync(join(reportDirectory, "deepseek-evaluation-v0.0.1-rc.2.json"), `${JSON.stringify(report, null, 2)}\n`, { mode: 0o644 });
